...
namespace ModAssistant.Pages
{
    ...
    public sealed partial class Mods : Page
    {
        ...
        public List<string> DefaultMods = new List<string>() { "SongCore", "ScoreSaber", "BeatSaverDownloader", "BeatSaverVoting", "PlaylistManager", "ModelDownloader", "MappingExtensions", "BetterSongList", "BetterSongSearch", "BSIPA" , "Noodle Extensions" , "NoodleExtensions" , "Chroma" , "SiraUtil" , "SiraLocalizer" };
